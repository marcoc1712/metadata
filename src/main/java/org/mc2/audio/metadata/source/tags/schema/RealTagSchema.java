 ...
 * @author marco
 */
public class RealTagSchema extends TagSchema  {
    
    RealTag realTag;
    
    public RealTagSchema(RealTag realTag, TagsSource source) {
        super(source);
    ...
    */
    public MetadataOrigin getMetadataOrigin(String source, FieldKey fieldKey) {
        ...
        try {
            ArrayList<TagField> list = (ArrayList) realTag.getFields(fieldKey);
