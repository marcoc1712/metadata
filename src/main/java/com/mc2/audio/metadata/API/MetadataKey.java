...
public class MetadataKey {
    ...
    public static enum METADATA_KEY {
		...
		AWARD(METADATA_CATEGORY.RESERVED, METADATA_CATEGORY.RESERVED),
		...
		WORK(METADATA_CATEGORY.RESERVED, METADATA_CATEGORY.RESERVED),
        ...
        LANGUAGE(METADATA_CATEGORY.WORK_DESCRIPTOR, METADATA_CATEGORY.WORK_DESCRIPTOR),
        ...
        TIMBRE(METADATA_CATEGORY.WORK_DESCRIPTOR, METADATA_CATEGORY.WORK_DESCRIPTOR),
	...
	*/
    ...
    static {
		...
		BOTH_LEVEL_ALIAS.put(METADATA_KEY.AWARD.name(), METADATA_KEY.AWARD.name());
		BOTH_LEVEL_ALIAS.put("AWARDS", METADATA_KEY.AWARD.name());
		BOTH_LEVEL_ALIAS.put("PRIZE", METADATA_KEY.AWARD.name());
