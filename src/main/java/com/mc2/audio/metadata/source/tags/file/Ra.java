...
import com.mc2.audio.metadata.source.tags.schema.RealTagSchema;
...
public class Ra extends AudioFile{
    ...
    public Ra(String path) throws InvalidAudioFileException  {
        super(path); 
    }
    
    public Ra(File file) throws InvalidAudioFileException {
         super(file);
    }
    @Override
