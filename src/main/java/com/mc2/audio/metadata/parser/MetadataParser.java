...
import static com.mc2.audio.metadata.source.cue.CueSection.ALBUM;
...
public class MetadataParser {
	...
	public static ArrayList<Metadata> merge(String level, ArrayList<Metadata> target, ArrayList<Metadata> source){
        ...
        for (Metadata toAdd : source){
            ...
            if (!found){
                target.add(new GenericMetadata(key, toAdd.getOrigins()));
            }
        }
